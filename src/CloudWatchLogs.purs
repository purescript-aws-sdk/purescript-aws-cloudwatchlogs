...
associateKmsKey = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "associateKmsKey"
...
createExportTask = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "createExportTask"
...
createLogGroup = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "createLogGroup"
...
createLogStream = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "createLogStream"
...
deleteDestination = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "deleteDestination"
...
deleteLogGroup = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "deleteLogGroup"
...
deleteLogStream = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "deleteLogStream"


-- | <p>Deletes the specified metric filter.</p>
deleteMetricFilter :: forall eff. DeleteMetricFilterRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
deleteMetricFilter = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "deleteMetricFilter"
...
deleteResourcePolicy = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "deleteResourcePolicy"
...
deleteRetentionPolicy = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "deleteRetentionPolicy"


-- | <p>Deletes the specified subscription filter.</p>
deleteSubscriptionFilter :: forall eff. DeleteSubscriptionFilterRequest -> Aff (exception :: EXCEPTION | eff) Types.NoOutput
deleteSubscriptionFilter = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "deleteSubscriptionFilter"
...
describeDestinations = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "describeDestinations"
...
describeLogGroups = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "describeLogGroups"
...
describeLogStreams = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "describeLogStreams"
...
describeMetricFilters = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "describeMetricFilters"
...
describeResourcePolicies = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "describeResourcePolicies"
...
describeSubscriptionFilters = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "describeSubscriptionFilters"
...
disassociateKmsKey = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "disassociateKmsKey"
...
filterLogEvents = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "filterLogEvents"
...
getLogEvents = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "getLogEvents"


-- | <p>Lists the tags for the specified log group.</p>
listTagsLogGroup :: forall eff. ListTagsLogGroupRequest -> Aff (exception :: EXCEPTION | eff) ListTagsLogGroupResponse
listTagsLogGroup = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "listTagsLogGroup"
...
putDestination = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "putDestination"
...
putDestinationPolicy = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "putDestinationPolicy"
...
putLogEvents = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "putLogEvents"
...
putMetricFilter = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "putMetricFilter"
...
putResourcePolicy = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "putResourcePolicy"
...
putRetentionPolicy = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "putRetentionPolicy"
...
putSubscriptionFilter = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "putSubscriptionFilter"
...
tagLogGroup = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "tagLogGroup"
...
testMetricFilter = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "testMetricFilter"
...
untagLogGroup = Request.request service method  where
    service = Request.ServiceName "CloudWatchLogs"
    method = Request.MethodName "untagLogGroup"
